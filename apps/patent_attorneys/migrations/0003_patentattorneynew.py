# Generated by Django 4.1.7 on 2025-10-09 20:28
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('patent_attorneys', '0002_patentattorneyext'),
    ]

    operations = [
        migrations.CreateModel(
            name='PatentAttorneyNew',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pat_id', models.IntegerField(blank=True, db_column='Pat_ID', null=True)),
